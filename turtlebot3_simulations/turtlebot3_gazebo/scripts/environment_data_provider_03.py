...
class EnvironmentDataProvider:
    ...
    def publish_environment_data(self):
        while not rospy.is_shutdown():
            ...
            # Extract corridor_01 dimensions
            corridor_01_length = self.environment_data.get('corridor_01_length')
            corridor_01_width = self.environment_data.get('corridor_01_width')

            # Extract corridor_02 dimensions
            corridor_02_length = self.environment_data.get('corridor_02_length')
            corridor_02_width = self.environment_data.get('corridor_02_width')

            # Check if all corridor dimensions are present
            if None in [main_corridor_length, main_corridor_width, corridor_01_length, corridor_01_width, corridor_02_length, corridor_02_width]:
            ...
            publish_data = {
                ...
                'corridor_01_length': corridor_01_length,
                'corridor_01_width': corridor_01_width,
                'corridor_02_length': corridor_02_length,
                'corridor_02_width': corridor_02_width,
                'objects': object_list
            }
